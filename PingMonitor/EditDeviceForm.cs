...
// Type: PingMonitor.EditDeviceForm
...
namespace PingMonitor
{
  public class EditDeviceForm : Form
  {
    ...
    public Device EditDevice = (Device) null;
    ...
    private void initValues(Device dev)
    {
      this.nameBox.Text = dev.Name;
      this.ipBox.Text = dev.IP.ToString();
      this.descBox.Text = dev.Description;
      this.intervalBox.Value = (Decimal) dev.PingInterval;
      this.timeoutBox.Value = (Decimal) dev.PingTimeout;
      this.arpCheckbox.Checked = dev.EnableARP;
      if (dev.EnableARP)
      {
        this.macLabel.Enabled = true;
        this.macBox.Enabled = true;
        this.macInfoLabel.Enabled = true;
        this.arpIntervalLabel.Enabled = true;
        this.arpIntervalBox.Enabled = true;
        this.arpIntervalMsLabel.Enabled = true;
        this.arpErrorBox.Enabled = true;
        this.arpErrorLabel.Enabled = true;
        this.changeArpErrorButton.Enabled = true;
      }
      this.macBox.Text = dev.MAC != null ? dev.MAC : "";
      this.arpIntervalBox.Value = (Decimal) (dev.ARPInterval != -1 ? dev.ARPInterval : 1000);
    }

    private void onClose(object sender, EventArgs e)
    {
      if (MessageBox.Show((IWin32Window) this, "Are you sure that you want to close? Any changes will be lost.", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) != DialogResult.Yes)
        return;
    ...
    {
      EditDeviceForm.lastError = error;
      return false;
    }
    ...
    private void onAddDevice(object sender, EventArgs e)
    {
      if (!this.checkValues())
      {
        int num = (int) MessageBox.Show((IWin32Window) this, EditDeviceForm.lastError, "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
      }
      else
      {
        ...
        this.EditDevice = flag ? new Device(lastX, lastY, this.onlineColor, this.offlineColor, this.arpErrorColor, text1, text2, iP, pingInterval, pingTimeout, mAC, aRPInterval) : new Device(lastX, lastY, this.onlineColor, this.offlineColor, this.arpErrorColor, text1, text2, iP, pingInterval, pingTimeout);
        for (int index = 0; index < 10; ++index)
        {
          this.Opacity = this.Opacity - 0.1;
          Thread.Sleep(10);
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (EditDeviceForm));
      ...
      this.designBox.Location = new Point(16, 329);
      this.designBox.Name = "designBox";
      this.designBox.Size = new Size(612, 100);
      this.designBox.TabIndex = 13;
      ...
      this.addButton.Location = new Point(16, 445);
      this.addButton.Name = "addButton";
      this.addButton.Size = new Size(612, 25);
      this.addButton.TabIndex = 12;
      this.addButton.Text = "Apply Changes";
      ...
      this.arpCheckbox.CheckedChanged += new EventHandler(this.changeArpEnabled);
      ...
      this.basicBox.Location = new Point(16, 43);
      this.basicBox.Name = "basicBox";
      this.basicBox.Size = new Size(612, 143);
      this.basicBox.TabIndex = 9;
      ...
      this.titleLabel.Location = new Point(12, 11);
      this.titleLabel.Name = "titleLabel";
      this.titleLabel.Size = new Size(100, 20);
      this.titleLabel.TabIndex = 8;
      this.titleLabel.Text = "Edit Device";
      ...
      this.closeButton.Location = new Point(603, 14);
